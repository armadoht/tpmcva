    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="hero">
                        <h1><span>Programa para lup's y estandares</span></h1>
                        <div class="bor"></div>
                    </div>
                </div>
                <div class="col-md-6">
                    <h4>TPM(Gestion Productiva Total)</h4>
                    <p>TPM es una filosofía de mantenimiento cuyo objetivo es eliminar las pérdidas en producción debidas al estado de los equipos, o en otras palabras, mantener los equipos en disposición para producir a su capacidad máxima productos de la calidad esperada, sin paradas no programadas. Esto supone: Cero averías.</p>
                    <a href="index.php?controller=login&action=index" class="btn btn-grupak-primary">Iniciar Sessión</a>
                </div>
                <!-- .\col-6-md-->
                <div class="col-md-6 text-center">
                    <img class="rounded" src="view/img/tpm-grupak/tpm-1.png">
                </div>
                <!-- .\col-6-md-->
            </div>
            <!-- .\row-->

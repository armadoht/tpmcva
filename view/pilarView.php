    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <!-- .\ col-md-12 -->
                <div class="col-md-12">
                    <form action="index.php?controller=pilar&action=createPilar" method="post">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="inputEmail4">Nombre del Pilar</label>
                                <input type="text" class="form-control" name="nombrePilar" placeholder="Escribe el nombre del pilar">
                            </div>
                ...
                <div class="col-md-12">
                    <table class="table">
                        <thead class="thead-dark">
                            <tr>
                                <th scope="col">#</th>
                                <th scope="col">Nombre del Pilar</th>
                        ...
                        <tbody>
                            ...
                            if (is_array($pilar)) {
                                foreach ($pilar as $valor) {
                                    ...
                                    if ($valor[2] == 1) {
                                        echo "<th>"
                                        . "<a href='index.php?controller=pilar&action=updatePilar&idPilar=".$valor[0]."&valor=0'>Activo</a>"
                                        . "</th>";
                                    }else{
                                        echo "<th>"
                                        . "<a href='index.php?controller=pilar&action=updatePilar&idPilar=".$valor[0]."&valor=1'>Inactivo</a>"
                                        . "</th>";
                                    }
                                    echo "<th><i class='far fa-trash-alt'></i>"
                                    ."<a href='index.php?controller=pilar&action=deletPilar&valor=".$valor[0]."'> Borrar</a></th>";
                                    echo "</tr>";
                                }
                            }
                            ?>

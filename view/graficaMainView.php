...
<html lang="en">
    ...
    <body>
        ...
        <script type="text/javascript">
            //conocer el tamaño del array de tipos delups
            //var array
            var array_baseTipo = <?php echo json_encode($array_baseTipo); ?>;
            var array_tipos = <?php echo json_encode($datos) ?>;
            var tamanio = array_baseTipo.length;
            
            
            var tags = [];
            for(let i=0; i< array_baseTipo.length; i++){
                tags.push(array_baseTipo[i].nombre);
            }
           
            var valores = [];
            for(let i=0; i<array_tipos.length; i++){
                valores.push(array_tipos[i].idTipoLup);
            }

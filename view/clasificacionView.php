    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <!-- .\ col-md-12 -->
                <div class="col-md-12">
                    <form action="index.php?controller=clasificacion&action=createClasificacion" method="post">
                        <div class="form-row">
                            ...
                            if (is_array($clasificacion)) {
                                foreach ($clasificacion as $valor) {
                                    ...
                                    if ($valor[3] == 1) {
                                        ...
                                        echo "<th>"
                                        . "<a href='index.php?controller=clasificacion&action=updateClasificacion&idClasificacion=" . $valor[0] . "&valor=1'>Inactivo</a>"
                                        . "</th>";
                                    }
                                    echo "<th><i class='far fa-trash-alt'></i>"
                                    . "<a href='index.php?controller=clasificacion&action=deletClasificacion&valor=" . $valor[0] . "'>Borrar</a></th>";
                                    echo "</tr>";
                                }
                            }
                            ?>

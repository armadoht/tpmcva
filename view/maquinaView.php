    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <!-- .\ col-md-12 -->
                <div class="col-md-12">
                    <form action="index.php?controller=maquina&action=createMaquina" method="post">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="inputEmail4">Nombre del la maquina</label>
                                <input type="text" class="form-control" name="nombreMaquina" placeholder="Escribe el nombre de la maquina">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputEmail4">Codigo de la Maquina</label>
                                <input type="text" class="form-control" name="codigo" placeholder="Codigo de la maquina">
                            </div>
                        ...
                        <tbody>
                            ...
                            if (is_array($maquina)) {
                                foreach ($maquina as $valor) {
                                    ...
                                    if ($valor[3] == 1) {
                                        echo "<th>"
                                        . "<a href='index.php?controller=maquina&action=updateMaquina&idMaquina=" . $valor[0] . "&valor=0'>Activo</a>"
                                        . "</th>";
                                    } else {
                                        echo "<th>"
                                        . "<a href='index.php?controller=maquina&action=updateMaquina&idMaquina=" . $valor[0] . "&valor=1'>Inactivo</a>"
                                        . "</th>";
                                    }
                                    echo "<th><i class='far fa-trash-alt'></i>"
                                    . "<a href='index.php?controller=maquina&action=deletMaquina&valor=" . $valor[0] . "'>Borrar</a></th>";
                                    echo "</tr>";
                                }
                            }
                            ?>

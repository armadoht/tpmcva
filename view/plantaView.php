    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    <form action="index.php?controller=planta&action=createPlanta" method="post">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="inputEmail4">Nombre del la Planta</label>
                                <input type="text" class="form-control" name="nombrePlanta" placeholder="">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputEmail4">Iniciales</label>
                                <input type="text" class="form-control" name="iniciales" placeholder="">
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <tbody>
                            ...
                            if (is_array($planta)) {
                                foreach ($planta as $valor) {
                                    ...
                                    echo "<th>" . utf8_encode($valor[1]) . "</th>";
                                    echo "<th>" . $valor[2] . "</th>";
                                    echo "<th>" . utf8_encode($valor[3]) . "</th>";
                                    echo "<th>" . utf8_encode($valor[4]) . "</th>";
                                    echo "<th>" . $valor[5] . "</th>";
                                    echo "<th>" . $valor[6] . "</th>";
                                    echo "<th>" . $valor[7] . "</th>";
                                    echo "<th>" . $valor[8] . "</th>";
                                    ...
                                    if ($valor[10] == 1) {
                                        ...
                                        echo "<th>"
                                        . "<a href='index.php?controller=planta&action=updatePlanta&idPlanta=" . $valor[0] . "&valor=1'>Inactivo</a>"
                                        . "</th>";
                                    }
                                    echo "<th><i class='far fa-trash-alt'></i>"
                                    . "<a href='index.php?controller=planta&action=deletPlanta&valor=" . $valor[0] . "'> Borrar</a></th>";
                                    echo "</tr>";
                                }
                            }
                            ?>
